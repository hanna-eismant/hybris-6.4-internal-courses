 ...
 */
public class CourseManager extends GeneratedCourseManager
{
	...
	{
		return (CourseManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CourseConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CourseManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CourseManager called.");
		}
	}
